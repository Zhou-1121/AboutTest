...
def setup_all():
    ...
    pk_pan.write4ByteTxRx(ph_pan,ID_PAN,ADDR_GOAL_POS,PAN_CENTER_TICK)
    pk_tilt.write4ByteTxRx(ph_tilt,ID_TILT,ADDR_GOAL_POS,TILT_CENTER_TICK)
...
if __name__ == '__main__':
    ...
    try:
        ...
        main_rs(frame_callback=servo_update,save_output=True,save_video=False, disable_vlm=False,video_source='camera',video_path='/data/shiqi/ImagePipelien/imagepipeline/output.mp4')
