...
class RoboticsSystem:
    def __init__(self, args):
        ...
        self.run_step = 30
        self.check_grasp_running = False
    ...
    def run_planner(self):
        while True:
            ...
            while not self.talk_mode:
                print("---------------second while-------------")
                self.step = 0
                res = self.get_current_instruction()
                if res:
                    bbox, accept_char = self.mark_bbox_planner()
                    if accept_char == 'n':
    ...
    def close(self):
        try:
            ...
            self.robot.move_to_zero_postion()
